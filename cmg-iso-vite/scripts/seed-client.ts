/**
 * Client-SDK seed script — no service account key required.
 * Uses the Firebase client SDK with the real project config.
...
const CPARS = [
  { id: "cpar-001", cparNo: "CPAR-2026-001", auditId: "ap-001", yearCycleId: "yc-2026", title: "Customer Complaint Handling Procedure", description: "Procedure not consistently followed by MKT staff",                    status: "PENDING_VERIFICATION", rootCause: "Staff not trained on updated procedure QP-MKT-003 Rev.2",                 correctiveAction: "Conducted training session for all MKT staff. Training records updated in FM-HR-002.", verificationResult: null,                                                                                                    issuedDate: ts("2026-02-18"), dueDate: ts("2026-04-18"), closedDate: null,              departmentId: "dept-mkt", department: { id: "dept-mkt", code: "MKT", name: "Marketing"        } },
  { id: "cpar-002", cparNo: "CPAR-2026-002", auditId: "ap-003", yearCycleId: "yc-2026", title: "Training Records Incomplete",          description: "Several employees missing mandatory ISO 9001 awareness training records", status: "PLANNING",              rootCause: "Training tracking spreadsheet not updated since Q4 2025 due to system migration", correctiveAction: null,                                                                                                              verificationResult: null,                                                                                                    issuedDate: ts("2026-04-22"), dueDate: ts("2026-06-22"), closedDate: null,              departmentId: "dept-hr",  department: { id: "dept-hr",  code: "HR",  name: "Human Resources" } },
  { id: "cpar-003", cparNo: "CPAR-2025-005", auditId: "ap-008", yearCycleId: "yc-2025", title: "Document Version Control Issue",       description: "Obsolete documents found in active work area",                           status: "CLOSED",               rootCause: "Document retrieval process not enforced during relocation",                       correctiveAction: "Removed all obsolete documents. Implemented document retrieval checklist.",                                verificationResult: "All obsolete documents removed and confirmed by QMR. Checklist implemented and verified.",                issuedDate: ts("2025-09-10"), dueDate: ts("2025-11-10"), closedDate: ts("2025-11-05"), departmentId: "dept-dcc", department: { id: "dept-dcc", code: "DCC", name: "Document Control" } },
  { id: "cpar-004", cparNo: "CPAR-2026-003", auditId: "ap-001", yearCycleId: "yc-2026", title: "Supplier Evaluation Not Conducted",    description: "Annual supplier evaluation for key MKT suppliers overdue by 3 months",    status: "ISSUED",               rootCause: null,                                                                               correctiveAction: null,                                                                                                              verificationResult: null,                                                                                                    issuedDate: ts("2026-03-10"), dueDate: ts("2026-05-10"), closedDate: null,              departmentId: "dept-mkt", department: { id: "dept-mkt", code: "MKT", name: "Marketing"        } },
];

const MANAGEMENT_REVIEWS = [
  { id: "mr-001", title: "Q1 2026 Management Review Meeting",    meetingDate: ts("2026-03-28"), status: "COMPLETED", yearCycleId: "yc-2026", agendaUrl: "https://example.com/mr-q1-2026-agenda.pdf",    minutesUrl: "https://example.com/mr-q1-2026-minutes.pdf",    notes: "Reviewed Q1 KPI results. 2 CPAR open items discussed. Audit schedule confirmed. All Q1 objectives met." },
...
const MOCS = [
  { id: "moc-001", mocNo: "MOC-2026-001", title: "New ERP System Implementation",           description: "Management of change for transitioning from legacy ERP to SAP S/4HANA across all departments.", status: "ACTION_IN_PROGRESS", requestorId: "usr-001", requestor: { id: "usr-001", name: "Admin QMR"      }, yearCycleId: "yc-2026", createdAt: ts("2026-01-15"), updatedAt: ts("2026-03-01") },
  { id: "moc-002", mocNo: "MOC-2026-002", title: "Warehouse Layout Restructuring",           description: "Reconfiguring warehouse storage zones to improve forklift safety and ISO 45001 compliance.",     status: "PENDING_APPROVAL",   requestorId: "usr-005", requestor: { id: "usr-005", name: "Panida Wan"    }, yearCycleId: "yc-2026", createdAt: ts("2026-02-20"), updatedAt: ts("2026-02-20") },
  { id: "moc-003", mocNo: "MOC-2026-003", title: "ISO 45001 PPE Requirements Update",        description: "Update PPE specifications based on ISO 45001:2018 clause 8.1.2 operational control requirements.", status: "MEETING_SETUP",    requestorId: "usr-003", requestor: { id: "usr-003", name: "Nattaya Ploy"  }, yearCycleId: "yc-2026", createdAt: ts("2026-04-05"), updatedAt: ts("2026-04-05") },
